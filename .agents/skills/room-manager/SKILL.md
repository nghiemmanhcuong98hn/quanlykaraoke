...
- **Schema chính:**
    ...
    - `Item`: `name`, `price`, `category` — Sản phẩm/dịch vụ có thể thêm vào mỗi lượt sử dụng.
...
- **Thêm tính năng Quản lý Sản phẩm (Items):**
    ...
    - **Admin UI:** Thêm menu "Sản phẩm" trong sidebar quản lý + bảng CRUD sản phẩm (tên, danh mục, giá).
